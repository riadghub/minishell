...
#    Updated: 2025/06/25 12:41:15 by rbourkai         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
dev: re
	make clean
	clear
	valgrind -s --track-fds=yes --trace-children=yes --show-leak-kinds=all  --track-origins=yes --leak-check=full -q ./minishell
